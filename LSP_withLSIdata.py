...
#------------------------------------------------------------
# Generate Data
file = uproot.open("Combined2_lsi2.root")

# this is where I would assign my time values, my flux values, and the error
t = 1
y = 3
dy = 0.1
y_obs = (y,dy)
...
# and now for the numpy way: 
omega2 = 1 / period
P_LS = LombScargle(t, y).power(omega2)

# a basic plot for the Lomb-Scargle Periodogram
fig = plt.figure()
plt.plot(period,P_LS)
#------------------------------------------------------------
